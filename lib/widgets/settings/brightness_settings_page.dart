        ...
        Expanded(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Selector<BrightnessService, bool>(
                  selector: (_, s) => s.hasPermission,
                ...
                Selector<BrightnessService, (bool, TimeSlot)>(
                  selector: (_, s) => (s.isEnabled, s.getCurrentTimeSlot()),
                  builder: (context, data, _) {
                    final (isEnabled, currentSlot) = data;
